<template>
    ...
    <DialogHomepage ref='dialogHomepage' :reload="getHomepageConfig" :type="state.type" :configType="state.configType" />
</template>
...
import DialogHomepage from "@/components/DialogHomepage.vue";
import {deleteHomepage, getHomepage} from "@/service/homepage.js";
...
const handleAdd = () => {
    state.type = 'add'
    dialogHomepage.value.open()
}

// 修改商品
const handleEdit = (id) => {
    state.type = 'edit'
    dialogHomepage.value.open(id)
}
